        ...
        <table class="table" id="datatables-reponsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$review->image}}</td>
                    <td>
                        <button data-toggle="modal" data-target="#edit_modal" name="{{$review->name}}" p_name="{{$review->p_name}}" amount="{{$review->amount}}" star="{{$review->star}}" page="{{$review->page}}"image="{{$review->image}}" message="{{$review->message}}" 
