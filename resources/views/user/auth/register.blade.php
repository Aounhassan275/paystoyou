                            ...
                            <div class="card-body">
                                ...
                                <div class="m-sm-4">
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            <label>Cnic#</label>
                                        	<input type="text" maxlength="15" minlength="15" id="cnic" placeholder="XXXXX-XXXXXXX-X"  name="cnic" class="form-control disablecopypaste" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="pwd" minlength="8" class="form-control form-control-lg" onkeyup="validatePassword(this.value);" type="password" name="password" placeholder="Enter password" required>
                                            <span id="msg"></span>
                                        </div> 
                                        <div class="form-group">
                                            <label>City</label>
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input name="address" type="text" class="form-control" placeholder="Complete Address" required>
                                        </div> 
                                        <div>
                                        ...
                                        data-sitekey="6Ledm_kUAAAAAEYsoeaRrNK9wJ3dr2uvnhwxex5u">
                                           
                                        </div> 
                                        <div class="text-center mt-3">
                                            {{-- <a href="{{url('/')}}" class="btn btn-lg btn-primary">Sign up</a> --}}
