...
<head>
    ...
    <title>RESET PASSWORD | ADVERT FOXX</title>   
                                ...
                                <form method="POST" action="{{route('user.resetPassword')}}">
                                    @csrf
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="verfication" >
                                        </div> 
                                        <div class="form-group">
                                        ...
                                        <div class="text-center mt-3">
                                            <button type="submit" class="btn btn-lg btn-primary">Rest Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
