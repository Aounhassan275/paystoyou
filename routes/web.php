...
Route::group(['prefix' => 'user', 'as'=>'user.','namespace' => 'User'], function () {
    ...
    Route::view('left_refferal_tree', 'user.refer.left_refferal')->name('left_refferal_tree.index');
    Route::view('right_refferal_tree', 'user.refer.right_refferal')->name('right_refferal_tree.index');
